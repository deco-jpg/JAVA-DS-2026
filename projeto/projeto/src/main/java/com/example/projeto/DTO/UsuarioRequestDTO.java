...
public class UsuarioRequestDTO {
    ...
    public @NotBlank(message = "O nome é obrigatório.") @Size(min = 2, message = "O nome deve ter no minimo dois caracteres") @Size(max = 100, message = "O nome deve ter no maximo 100 caracteres") String getNome() {
        return nome;
    }

    public void setNome(@NotBlank(message = "O nome é obrigatório.") @Size(min = 2, message = "O nome deve ter no minimo dois caracteres") @Size(max = 100, message = "O nome deve ter no maximo 100 caracteres") String nome) {
        this.nome = nome;
    }
